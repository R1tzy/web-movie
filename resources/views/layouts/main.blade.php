...
<head>
    ...
    <livewire:styles/>
    <!-- script -->
    <script src="https://unpkg.com/ionicons@4.5.10-0/dist/ionicons.js"></script> <!-- ion icons -->
    <script defer src="https://unpkg.com/alpinejs@3.10.5/dist/cdn.min.js"></script> <!-- cdn alpine js-->
</head>
<body class="font-sans bg-[#1A202C] text-white">
    
    <header class="border-b border-gray-700"> 
        <nav class="container mx-auto px-4 py-6 flex flex-col lg:flex-row items-center justify-between">
            <div class="flex flex-col lg:flex-row items-center">
                ...
                <ul class="flex flex-row mt-3 lg:flex-row lg:ml-16 space-x-8 lg:mt-0">
                    <li>
            ...
            <div class="flex flex-col items-center lg:flex-row lg:mt-0 mt-3">
                <livewire:search-dropdown/>
                <div class="ml-4">
                    <a href="#">
                        <img src="/img/avatar.jpg" alt="avatar" class="w-8 h-8 rounded-full mt-3 lg:mt-0">
                    </a>
                </div>
            </div>
        </nav>
    ...
    <footer class="border-t border-gray-700">
        <div class="container mx-auto px-4 py-6">
            Desenvolvido por <a href="https://github.com/R1tzy" target="_blank" rel="external" b class="underline font-medium hover:text-gray-300">Yozaru</a>
        </div>
    </footer>
    <livewire:scripts/>
    @yield('script')
