...
@section('content')
    <div class="container mx-auto px-4 py-16 border-b border-gray-700">
        <div class="movie-info flex lg:flex-row flex-col lg:gap-24 gap-8"> <!-- start movie info -->
            <div class="flex-none">
                <a href="#">
                    <img src="{{$details['poster_path']}}" alt="movie-poster" class="rounded-md hover:opacity-75 transition ease-in-out duration-150 shadow shadow-gray-200/10 w-64 lg:w-96">
                </a>
            </div>
            <div>
                ...
                <div class="flex flex-row text-sm items-center mt-2 text-gray-300 flex-wrap">
                    ...
                    <span class="ml-1">{{$details['release_date']}}</span>
                    <span class="mx-2">|</span>
